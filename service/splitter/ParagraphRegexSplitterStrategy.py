...
class ParagraphRegexSplitterStrategy(ISplitter):
    ...
    def split_content(content, config):
        ...
        try:
            ...
            raise Exception("Error al dividir el contenido. Índice fuera de rango.")
        
        except KeyError:
            raise Exception("Error al dividir el contenido. Clave no encontrada en la configuración.")
